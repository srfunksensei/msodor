...
public class DocReaderTest {
    ...
    private static final String DOC_BLANK = "test_blank.doc";
    private static final String DOC_WITH_DATA = "test_data.doc";

    private final DocReader underTest = new DocReader();
